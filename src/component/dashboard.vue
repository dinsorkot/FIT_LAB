        ...
        <div class="col">
          <div class="row w-100 color" style="width: 20rem; height: 15rem; border-radius: 25px">
            <div class="col d-flex justify-content-center align-items-center">
              <div class="bg-white w-60 h-55 m-4" style="border-radius: 25px; height: 100px">
            ...
            <div class="col mt-4">
              ...
              <div class="row">2456</div>
              <div class="row">DAILY AVERAGE</div>
            </div>
          </div>
        </div>
        <div class="col">
        ...
        <div class="d-flex">
          <div class="row">
            <div class="col w-100 h-100">
              <div class="bg-white mt-5" style="width: 150px; height: 200px; margin-left: 20%; border-radius: 100px">
              </div>
            </div>
